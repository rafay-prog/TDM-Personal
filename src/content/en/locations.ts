...
export const offices: Office[] = [
  {
    ...
    metaTitle: "Digital Marketing Agency in Dubai, UAE | TDM Services",
    metaDescription:
      "TDM is a Dubai-headquartered digital agency delivering SEO, performance marketing, media production and web development for UAE and GCC brands. 100% client satisfaction.",
    hero: {
      headline: "Your digital growth partner in Dubai.",
    ...
    faqs: [
      {
        q: "Where is TDM's Dubai office located?",
        a: "TDM's headquarters is at 17 12 A Street, Al Qusais Industrial Area 1, Dubai, United Arab Emirates (P.O. Box 231578). You can reach us at +971 58 909 4045 or info@thedigitalmarketing.services.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      {
        q: "What does TDM's Pakistan office do?",
        a: "Lahore is TDM's global delivery hub: 50+ marketing and technology specialists deliver SEO, development, design, video editing and campaign management for TDM clients worldwide, and dedicated staff-augmentation teams for international companies.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      {
        q: "Does TDM work with US-based businesses?",
        a: "Yes. TDM has US presence in South Florida and Greenville, South Carolina, and has delivered websites, SEO and marketing for US clients in property management, logistics, transportation, forestry products and beauty e-commerce.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. French is one of TDM's three working languages. We produce French SEO content, French ad campaigns and French websites natively, including for European and African francophone markets.",
      },
    ],
  },
  {
    ...
    hero: {
      headline: "Global digital services, Japanese presence.",
      sub: "TDM's Gifu office connects Japanese businesses to world-class e-commerce marketing, development and dedicated offshore teams.",
    },
    intro: [
      "TDM maintains a presence in Gifu Prefecture, Japan, serving Japanese businesses that want international-standard digital marketing and development with a local point of contact.",
      "Japanese clients particularly benefit from our staff-augmentation model: dedicated English-capable developers and marketers at globally competitive rates, managed end-to-end by TDM.",
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    faqs: [
      {
        q: "Does TDM work with French companies?",
        a: "Yes. TDM has sales partners in France and deep French-market experience: legal-services platforms, company-formation portals, debt-recovery sites and premium real-estate brands, all delivered natively in French.",
      },
    ],
  },
  {
    ...
    role: "partner",
    roleLabel: "Bulgaria Office",
    metaTitle: "Digital Marketing & Development Partner in Bulgaria | TDM",
    metaDescription:
      "TDM serves Bulgarian and Southeast European businesses with digital marketing, e-commerce development and dedicated offshore teams.",
    hero: {
      headline: "Serving Bulgaria and Southeast Europe.",
      sub: "TDM brings performance marketing, e-commerce development and staff augmentation to Bulgarian businesses through our local partners.",
    },
    intro: [
      "TDM works with Bulgarian and Southeast European businesses through local sales partners, delivering the same services our clients get worldwide: performance marketing, SEO, e-commerce and custom development, media production and staff augmentation.",
    ],
    faqs: [
      {
